    ...
    >
      ...
      <div>
        ...
        <p className="text-sm text-text-secondary font-body mt-1">
          Export <span className="font-mono text-cyan">{symbol}</span> data in multiple formats for analysis, reporting, and sharing.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          { label: 'Total Variants', value: stats.clinvarCount, color: 'text-cyan', icon: Dna },
          { label: 'Pathogenic', value: stats.pathogenic, color: 'text-magenta', icon: AlertTriangle },
          { label: 'Data Sources', value: stats.sourcesAvailable, color: 'text-helix-green', icon: Database },
          { label: 'Diseases', value: stats.diseaseCount, color: 'text-amber', icon: Activity },
        ].map((stat) => {
              ...
              >
                <GlassCard>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-heading font-semibold text-text-primary mb-1">{fmt.name}</h4>
      ...
      {/* Research Disclaimer */}
      <div className="p-4 rounded-xl border border-magenta/20 bg-magenta/5">
        <div className="flex items-start gap-3">
          <AlertTriangle className="w-4 h-4 text-magenta shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-heading font-semibold text-magenta mb-1">Research Use Only</p>
            <p className="text-xs text-magenta/70 font-body leading-relaxed">
