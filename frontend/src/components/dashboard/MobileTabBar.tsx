...
export default function MobileTabBar({ symbol, badges = {} }: MobileTabBarProps) {
  ...
  return (
    <div
      className="md:hidden sticky z-30 bg-white border-t border-ocean-100 overflow-x-auto scrollbar-hide shadow-sm"
      style={{
            ...
            <button
              ...
              className={`
                ...
                ${isActive
                  ...
                  : 'text-text-muted hover:text-text-secondary hover:bg-ocean-50'
                }
              `}
            >
              ...
              {badgeCount !== undefined && badgeCount > 0 && (
                <span className="min-w-[16px] h-4 flex items-center justify-center px-0.5
                  rounded-full text-[9px] font-mono font-bold bg-ocean-100 text-text-secondary">
